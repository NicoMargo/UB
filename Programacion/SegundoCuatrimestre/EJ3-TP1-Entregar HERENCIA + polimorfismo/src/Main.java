public class Main {
    public static void main(String []args) {
        ...
        do{
            ...
            if (catalogo == 2) { //si el catalogo elegido es dvd
                do {
                    operacion = Helper.nuevaOperacionDVD(); //Se elige la operacion DVD
                }while(Helper.iniciarOperacionDVD(operacion,catalogo));//Se ejecuta la operacion DVD
            }else if(catalogo == 1){ //si el catalogo elegido es CD
                do {
                    operacion = Helper.nuevaOperacionCD();//Se elige la operacion CD
                }while(Helper.iniciarOperacionCD(operacion,catalogo)); //Se ejecuta la operacion CD
            }
