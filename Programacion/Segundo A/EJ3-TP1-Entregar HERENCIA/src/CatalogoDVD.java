...
public class catalogoDisco {
    private static ArrayList<DVD> catalogoDisco = new ArrayList<DVD>();
    ...
    public static void eliminarDVD() { //metodo que elimina un dvd
        ...
        for(DVD midvd : catalogoDisco){ //recorro todos los dvd
            if (midvd.getTitulo().equalsIgnoreCase(tituloEliminar)){ //pregunto por cada dvd si es igual al titulo ingresado
                catalogoDisco.remove(midvd); //si encuentro el dvd se elimina
                encontrado = true;
    ...
    public static void modificarDVD(){
        ...
        boolean encontrado = false;
        for(DVD midvd : catalogoDisco){ //se recorre la lista
    ...
    public static void mostrarTodosDvd(){
        ...
        for(DVD undvd : catalogoDisco){ //recorro toda el arraylist
    ...
    public static void mostrarDvdQueTengo(){
        ...
        for(DVD undvd : catalogoDisco){ //recorro todo el arraylist
    ...
    public static void informarCantidadDVD(){
        System.out.println("El total de dvd en el catalogo es " + catalogoDisco.size()); //se muestra el size del catalogoDisco
    }

    public static void informarCantidadDVDQueTengo(){
        int contadorDvd = 0; //se declara e inicializa el contador en 0
        for(DVD unDvd : catalogoDisco){ //recorro el catalogo
