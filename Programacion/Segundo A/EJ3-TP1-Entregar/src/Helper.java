...
public class Helper {
    ...
    public static boolean iniciarOperacionDVD(short opcion){ //se recive como parametro el numero de opcion y se ejecuta
        ...
        switch(opcion){
            case 1:
                CatalogoDVD.nuevoDVD();
                break;
            case 2:
                CatalogoDVD.eliminarDVD();
                break;
            case 3:
                CatalogoDVD.modificarDVD();
                break;
            case 4:
                CatalogoDVD.mostrarTodosDvd();
                break;
            case 5:
                CatalogoDVD.mostrarDvdQueTengo();
                break;
            case 6:
                CatalogoDVD.mostrarDvdMenorTiempo();
                break;
            case 7:
                CatalogoDVD.mostrarDvdPorDirector();
                break;
            case 8:
                CatalogoDVD.ordenarXTitulo();
                break;
            case 9:
                CatalogoDVD.informarCantidadDVD();
                break;
            case 10:
                CatalogoDVD.informarCantidadDVDQueTengo();
                break;
            case 11:
                seguir = false;
                break;
